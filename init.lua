...
--freethesekeysfor accept/rejectsuggestions
		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("<leader>rn", vim.lsp.buf.rename, "[R]e[n]ame") --TODO: <leader>c old
					map("<leader>lr", vim.lsp.buf.rename, "[l]sp [r]ename") --TODO: <leader>c new
					-- Execute a code action, usually your cursor needs to be on top of an error
					-- or a suggestion from your LSP for this to activate.
					map("<leader>ca", vim.lsp.buf.code_action, "[C]ode [A]ction") -- TODO: <leader>c old
					map("<leader>la", vim.lsp.buf.code_action, "[l]sp [a]ction") -- TODO: <leader>c new
					-- WARN: This is not Goto Definition, this is Goto Declaration.
					--  For example, in C this would take you to the header.
					-- map("gD", vim.lsp.buf.declaration, "[G]oto [D]eclaration") -- TODO: <leader>c old
					-- map("<leader>ld", vim.lsp.buf.definition, "goto [d]definition")
					-- map("<leader>lD", vim.lsp.buf.declaration, "goto [D]eclaration") -- TODO: <leader>c new
					-- map("<leader>lR", vim.lsp.buf.references, "find [R]references")
